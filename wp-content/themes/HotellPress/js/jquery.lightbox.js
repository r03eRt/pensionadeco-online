...
{	// Create our Plugin function, with $ as the argument (we pass the jQuery object over later)
	...
	{	// Our LightboxClass definition
		...
		files: {
			compressed: {
				scripts: {
					lightbox:	img_link1+'js/jquery.lightbox.min.js',
					colorBlend:	img_link1+'js/jquery.color.min.js'
				},
				styles: {
					lightbox:	img_link1+'css/jquery.lightbox.min.css'
				}
			},
			uncompressed: {
				scripts: {
					lightbox:	img_link1+'js/jquery.lightbox.js',
					colorBlend:	''
				},
				styles: {
					lightbox:	img_link1 + 'css/jquery.lightbox.css'
				}
			},
			images: {
				prev:		img_link1 + 'images/prevlabel.gif',
				next:		img_link1 + 'images/nextlabel.gif',
				blank:		img_link1 + 'images/bank.gif',
				loading:	img_link1 + 'images/loading.gif'
			}
		},
